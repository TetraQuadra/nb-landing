    ...
    return (
        <div>
            ...
            <footer className="py-4 px-8 ">
                <div className="flex justify-between items-center max-md:flex max-md:flex-col md:items-start max-md:gap-3">
                    ...
                    <div className="flex gap-6 max-lg:flex-col max-md:w-full max-md:gap-3">
